# -*- coding: utf-8 -*-
"""
******************* Validación del metodo no estacionario: Impulso ***************************************
 - Validación del código por medio de una aceleración instantánea, solución de Kussner
"""
...
#plt.plot(Clk, label = 'Solucion de Kussner')
plt.legend()
